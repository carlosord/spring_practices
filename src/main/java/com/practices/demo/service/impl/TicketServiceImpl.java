...
public class TicketServiceImpl implements TicketService {
	...
	public byte[] generatePDFReserveReport() throws IOException {
		...
		Path path = Paths.get("InformeReservas_" + date.toString() + ".pdf");
		...
		JRBeanCollectionDataSource carReserveCollectionList = new JRBeanCollectionDataSource(reserveHotelList);
		JRBeanCollectionDataSource hotelReservaCollectionList = new JRBeanCollectionDataSource(reserveCarList);

		// params.put("date", ;

		params.put("ticketReserveCar", carReserveCollectionList);
		params.put("ticketReserveHotel", hotelReservaCollectionList);
